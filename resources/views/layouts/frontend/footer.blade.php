                ...
                <div class="col-lg-3 col-md-6 col-sm-6">
                    <div class="footer-menu">
                        @auth
                            ...
                            <div
                                style="width: 100px; height: 100px; background-color: #eee; border: 2px solid #ccc; display: flex; justify-content: center; align-items: center; margin-bottom: 15px;">
                                <img src="{{ auth()->user()->image ? asset('storage/' . auth()->user()->image) : asset('backend/assets/images/nguwawor.jpg') }}"
                                    alt="Profile Photo" style="max-width: 100%; max-height: 100%;">
                            </div>
                        @else
                        @endauth

                        <h5 class="widget-title" style="margin-bottom: 5px;">Waiter Cafe</h5>
                        <p style="margin-bottom: 0px; color: #aaa;">waiter@gmail.com</p>
                        <p style="font-weight: bold; color: #ffc107;">Role: WAITER</p>

                        <div class="mt-3">
                            <form action="{{ route('logout') }}" method="POST">
                                @csrf
                                <button type="submit" class="btn btn-dark rounded-end rounded-0">Log Out</button>
                            </form>
                        </div>
